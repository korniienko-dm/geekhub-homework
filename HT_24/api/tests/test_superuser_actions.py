...
class ProductAPITest(APITestCase):
    ...
    def test_create_product(self):
        ...
        category = Category.objects.get(
            name=self.product_data['parent_category'])
    ...
    def test_update_product(self):
        ...
        self.assertEqual(Product.objects.get(
            id=self.product.id).name, "Updated Test Product")
    ...
    def test_change_product_quantity_in_cart(self):
        ...
        response_data_list = [
            (item['product_id'], item['product_quantity']) for item in response.data]
    ...
    def test_create_category(self):
        ...
        response = self.client.post(url, data, format='json')
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
        self.assertEqual(response.data, {'id': 2, 'name': 'New_category'})
    ...
    def test_update_category(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data, {'id': 1, 'name': 'Updated Test Category'})
